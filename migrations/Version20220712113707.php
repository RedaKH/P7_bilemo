 ...
 */
final class Version20220712113707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE customer ADD CONSTRAINT FK_81398E099395C3F3 FOREIGN KEY (customer_id) REFERENCES customer (id)');
